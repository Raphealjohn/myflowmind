...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Tell us what you need — automation, real estate, notarization, or security — and your inquiry routes straight to the right Kayjay company.",
    ...
    <Container className="grid gap-14 py-20 sm:py-28 lg:grid-cols-[1fr_1.2fr]">
      <div>
        ...
        <p className="mt-6 max-w-md text-lg text-muted">
          Pick what you need and your message routes directly to the right Kayjay
