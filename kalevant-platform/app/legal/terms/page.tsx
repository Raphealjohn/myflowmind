      ...
      <div className="mt-10 space-y-8 leading-relaxed">
        <section>
          ...
          <p className="mt-3 text-muted">
            This website is operated by Kalevant Group LLC of West Des Moines, Iowa, on
        ...
        <section>
          ...
          <p className="mt-3 text-muted">
            ...
            Kalevant Group LLC or its operating companies. Gated resources are licensed
        ...
        <section>
          ...
          <p className="mt-3 text-muted">
            ...
            Kalevant Group LLC is not liable for indirect or consequential damages
